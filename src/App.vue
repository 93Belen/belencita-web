...
<div id="container" class="m-0 p-0 bg-darkpink overflow-x-hidden snap-start w-screen scroll-smooth">
  <header @click="onClick" :class="open ? 'translate-x-[10px]' : 'translate-x-[193px] md:translate-x-0'" class="fixed max-h-[80px] md:static pt-6 md:pt-0 z-[999] md:backdrop-blur-sm bg-gradient-to-b from-darkpink via-transparent via-60% md:flex w-full justify-end h-[50px] md:h-[10vh] font-body font-black text-md transition-all duration-[1s] ease-out">
  <nav class="my-auto flex justify-end w-full">
    <ul class="flex justify-self-end flex-col md:flex-row gap-5 p-2 md:p-0 border-2 max-w-screen md:border-0 border-black rounded-lg md:gap-0 w-fit bg-purple pr-6 md:pr-0 relative md:flex md:bg-transparent md:w-[80vw] xl:w-[50vw] justify-around">
