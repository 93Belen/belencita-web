...
<div id="desktop-maps-text" class="bg-white w-full max-h-[530px] md:max-h-[900px] 2xl:border-b-2 border-black">
    ...
    <div class="bg-white md:min-h-[750px] max-w-[1900px] m-auto md:max-h-[898px] overflow-hidden py-10 md:py-0 2xl:border-b-0 border-b-2 border-black md:grid md:grid-rows-1 md:grid-cols-[40%_60%] text-black">
