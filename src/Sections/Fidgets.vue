...
<template>
<div class="bg-white">
    <div id="desktop-fidget-div" class="min-h-[400px] max-h-[70vh] md:max-w-[90vw] m-auto md:min-h-[750px] max-h-[1000px] overflow-hidden md:h-screen w-screen bg-white pt-10">
       <div :role="mobile? 'tablist' : ''" :class="mobile ? 'tabs tabs-lifted grid-cols-5 h-full' : 'h-full md:grid grid-cols-3 grid-rows-4'">
            ...
            <div :role="mobile? 'tabpanel' : ''" :class="mobile? 'tab-content bg-pink p-6 h-[70vh]':'mockup-window bg-pink border row-span-3 col-start-1 row-start-2'">
                <div class="md:hidden m-auto w-[90%] bg-[#ECECE9] h-[47px] rounded-xl my-2 p-3 text-xs"><p>https://belenmadefidgets.com/play</p></div>
